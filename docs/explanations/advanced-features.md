...
the production `Pipeline` (see `src/pipeline/train_pipeline.py`).Example:
...
- Use `src/pipeline/train_pipeline.py` for production training to ensure
...
- Use `src/pipeline/train_pipeline.py` for production training to ensure```python
...
`src/pipeline/train_pipeline.py`.Keep transformations reproducible: implement them as transformers in

the production `Pipeline` (see `src/pipeline/train_pipeline.py`).
