...
docker run -p 5000:5000 \
  -v $(pwd)/saved_models/pipeline:/app/saved_models/pipeline \
...
services:
  web:
    ...
    ports:
      - "5000:5000"
    volumes:
      - ./saved_models/pipeline:/app/saved_models/pipeline
      - ./logs:/app/logs
    environment:
...
| `PREPROCESSOR_PATH` | Path to preprocessor | `saved_models/pipeline/preprocessor.pkl` |
